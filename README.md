...
*SmartGrow SecureAI in Action / SmartGrow AI*
...
6. [Main Features](#main-features-7-pages)
7. [Security System](#security-system)
8. [Triple Encryption](#triple-encryption)
9. [GPIO Control](#gpio-control)
10. [Installation](#installation)
    - [Windows](#windows)
    - [macOS](#macos)
    - [Linux](#linux-ubuntudebian)
    - [Raspberry Pi](#raspberry-pi)
11. [Build & Compilation](#build--compilation)
...
+150% - Increase in IoT attacks
40%   - Crop losses from attacks
$2.5M - Average damage per farm
73%   - Farms without protection 
```
